...
!function (t, n) {
  ...
  function d(t) {
    var n,
        e,
        a = void 0 === t.grouping || void 0 === t.thousands ? c : (n = h.call(t.grouping, Number), e = t.thousands + "", function (t, i) {
    ...
    function M(t) {
      var n = (t = o(t)).fill,
          ...
          b = t.trim,
          w = t.type;
      "n" === w ? (y = !0, w = "g") : u[w] || (void 0 === x && (x = 12), b = !0, w = "g"), (h || "0" === n && "=" === i) && (h = !0, n = "0", i = "=");
      ...
      function A(t) {
        ...
        if ("c" === w) f = k(t) + f, t = "";else {
          ...
          }(t)), p && 0 == +t && "+" !== e && (p = !1), c = (p ? "(" === e ? e : g : "-" === e || "(" === e ? "" : e) + c, f = ("s" === w ? l[8 + r / 3] : "") + f + (p && "(" === e ? ")" : ""), z) for (o = -1, s = t.length; ++o < s;) if (48 > (u = t.charCodeAt(o)) || u > 57) {
        ...
        switch (y && h && (t = a(N + t, N.length ? M - f.length : 1 / 0), N = ""), i) {
          case "<":
            t = c + t + f + N;
            break;
