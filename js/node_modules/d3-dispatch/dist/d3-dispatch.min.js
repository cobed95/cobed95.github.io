...
!function (n, e) {
  ...
  function f(n, t, r) {
    for (var o = 0, i = n.length; o < i; ++o) if (n[o].name === t) {
  ...
  r.prototype = t.prototype = {
    ...
    on: function (n, e) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++u < a;) if (t = (n = l[u]).type) r[t] = f(r[t], n.name, e);else if (null == e) for (t in r) r[t] = f(r[t], n.name, null);
    ...
    call: function (n, e) {
      if ((t = arguments.length - 2) > 0) for (var t, r, o = new Array(t), i = 0; i < t; ++i) o[i] = arguments[i + 2];
