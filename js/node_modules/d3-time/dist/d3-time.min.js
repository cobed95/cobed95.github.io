...
!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).d3 = e.d3 || {});
}(this, function (e) {
  "use strict";
  ...
  function u(e, r, i, o) {
    ...
    return a.floor = function (t) {
    ...
    }, a.range = function (t, n, u) {
      var i,
          o = [];
      if (t = a.ceil(t), u = null == u ? 1 : Math.floor(u), !(t < n && u > 0)) return o;
      ...
      return u(function (n) {
        ...
        if (e >= e) if (n < 0) for (; ++n <= 0;) for (; r(e, -1), !t(e););else for (; --n >= 0;) for (; r(e, 1), !t(e););
      });
    }, i && (a.count = function (u, r) {
      return t.setTime(+u), n.setTime(+r), e(t), e(n), Math.floor(i(t, n));
    }, a.every = function (e) {
  ...
  r.every = function (e) {
    return e = Math.floor(e), isFinite(e) && e > 0 ? e > 1 ? u(function (t) {
  ...
  var i = r.range,
    ...
    return e.getMinutes();
      ...
      l = f.range,
      g = u(function (e) {
    e.setTime(e - e.getMilliseconds() - 1e3 * e.getSeconds() - e.getMinutes() * o);
  }, function (e, t) {
    e.setTime(+e + 36e5 * t);
  }, function (e, t) {
    return (t - e) / 36e5;
    ...
    return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * o) / 864e5;
  }, function (e) {
    return e.getDate() - 1;
  }),
      m = d.range;
  ...
  function M(e) {
    return u(function (t) {
      ...
      return (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * o) / a;
    });
  }
  ...
  x.every = function (e) {
    return isFinite(e = Math.floor(e)) && e > 0 ? u(function (t) {
