...
!function (t, i) {
  ...
  e.prototype = _.prototype = {
    ...
    bezierCurveTo: function (t, i, s, h, e, _) {
      this._ += "C" + +t + "," + +i + "," + +s + "," + +h + "," + (this._x1 = +e) + "," + (this._y1 = +_);
    },
    arcTo: function (t, s, h, e, _) {
      ...
      if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = s);else if (c > 1e-6) {
        if (Math.abs(f * r - a * u) > 1e-6 && _) {
          ...
          Math.abs(b - 1) > 1e-6 && (this._ += "L" + (t + b * u) + "," + (s + b * f)), this._ += "A" + _ + "," + _ + ",0,0," + +(f * x > u * y) + "," + (this._x1 = t + w * r) + "," + (this._y1 = s + w * a);
    ...
    arc: function (t, e, _, n, o, r) {
      ...
      if (_ < 0) throw new Error("negative radius: " + _);
      null === this._x1 ? this._ += "M" + f + "," + c : (Math.abs(this._x1 - f) > 1e-6 || Math.abs(this._y1 - c) > 1e-6) && (this._ += "L" + f + "," + c), _ && (y < 0 && (y = y % s + s), y > h ? this._ += "A" + _ + "," + _ + ",0,1," + x + "," + (t - a) + "," + (e - u) + "A" + _ + "," + _ + ",0,1," + x + "," + (this._x1 = f) + "," + (this._y1 = c) : y > 1e-6 && (this._ += "A" + _ + "," + _ + ",0," + +(y >= i) + "," + x + "," + (this._x1 = t + _ * Math.cos(o)) + "," + (this._y1 = e + _ * Math.sin(o))));
    },
  ...
  }, t.path = _, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});